...
export default function NextBestCard({ rec, onDone, onSnooze }: { rec: RecommendationItem; onDone: (id: string | number, status: TaskStatus) => void; onSnooze: (id: string | number) => void }) {
  const t = rec.task
  return (
      ...
      <div className="flex items-start justify-between">
        <div>
          <div className="inline-flex items-center gap-2 mb-1">
            <span className="text-xs px-2 py-0.5 rounded-full bg-blue-600 text-white" aria-label="Next best task">Recommended</span>
